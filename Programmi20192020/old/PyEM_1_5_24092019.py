...
class Ebook:
    ...
    def save_page(self):
        ...
        #print(read)
        print("Inserisci questo nel file index.html rigo 69 circa")
        print(f"<li><a href='https://formazione.github.io/text/{current}.html />")
        with open("..\\newlinks.js", "w") as file:
            linka = str(self.lstb.get(tk.ACTIVE))
            linka = linka.replace("\\", "\\\\")
            file.write(f"""newlinks.innerHTML = "<a href='H:\\formazione.github.io\\formazione.github.io\Programmi20192020\\{current}.html'>{linka} (html)</a>" """)
