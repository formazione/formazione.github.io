...
testo = """<div style="background-color:lightblue">"""
...
with open("prova_quiz.html", "w", encoding="utf-8") as file:
    quest("Le immobilizzazioni vanno nello", "patrimoniale", "stato", "conto", "relazione", "non lo so")
    testo += code
    file.write(testo)

os.startfile("prova_quiz.html")