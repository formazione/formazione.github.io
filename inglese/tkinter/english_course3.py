...
# ===================================================================================
# 1. DATABASE SETUP
# Added get_leaderboard_data to rank users by average score.
# ===================================================================================
class Database:
...
# ===================================================================================
# (Data dictionaries and PracticeModule remain the same)
# ===================================================================================
LESSON_DATA = {
    'present_simple': {
...
class PracticeModule(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        self.check_btn = tk.Button(exercise_frame, text="Check Answers", command=self.check_answers, bg='#28a745', fg='white', font=('Arial', 12, 'bold'), pady=5); self.check_btn.pack(pady=15)
    def check_answers(self):
        ...
        self.check_btn.config(state='disabled'); messagebox.showinfo("Score", f"You scored {correct_count}/{total_questions}.", parent=self)
...
# ===================================================================================
# ANALYTICS WINDOW - Now includes the Leaderboard
# ===================================================================================
...
class EnglishLearningApp:
    ...
    def create_exercise_frame(self, parent, title, questions, lesson_key):
        ...
        self.check_btn = tk.Button(exercise_frame, text="Check Answers", command=lambda: self.check_answers(lesson_key), bg='#28a745', fg='white', font=('Arial', 12, 'bold'), pady=5); self.check_btn.pack(pady=15)
    def check_answers(self, lesson_key):
        ...
        self.check_btn.config(state='disabled'); messagebox.showinfo("Score", f"You scored {correct_count}/{total_questions}. Progress saved.")
    def next_slide(self):
