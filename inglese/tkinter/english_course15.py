...
import pygame
import re
from morelessons2 import LESSON_DATA, COURSES # <-- IMPORT LESSON DATA
...
class PracticeModule(BaseExerciseWindow):
    ...
    def display_lesson(self, lesson_key):
        ...
        # --- REORDERED LOGIC TO FIX PACKING ERROR ---
        # Display rules first if they exist
        if self.lesson_data.get('type') != 'word_bank':
