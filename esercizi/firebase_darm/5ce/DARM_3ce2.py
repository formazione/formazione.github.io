...
def create_html(filename):
	...
	print(filename)
	with open("esercizi\\template3_3ce.html") as file:
		filetext = file.read()
	...
	# SOSTITUISCI IL NOME DEL RECORD IN CUI REGISTRARE I RISULTATI DEL TEST IN FIREBASE
	filetext = filetext.replace("3ce2020_prova", filename)
	file_write("esercizi\\" + filename + ".html", filetext)
	os.startfile("esercizi\\" + filename + ".html")
...
def create_domande_js(filename):
	...
	domandejs += "];"
	with open(f"esercizi\\{filename}.js", "w") as file:
		file.write(domandejs)
	# os.startfile("domande.js")



# os.chdir("H:\\formazione.github.io\\formazione.github.io\\esercizi\\dati\\")
# os.startfile("notepad H:\\formazione.github.io\\formazione.github.io\\esercizi\\dati\\")
# os.chdir("..\\")
fn = menu()
fn = fn.split("\\")[1]
print(fn)
...
create_html(fn[:-4])
# createDarm()
os.chdir("H:\\formazione.github.io\\formazione.github.io\\Programmi20192020\\")
os.startfile("H:\\formazione.github.io\\formazione.github.io\\Programmi20192020\\PyEBook_5CE_3c.py")
os.startfile("H:\\formazione.github.io\\formazione.github.io\\esercizi\\firebase_darm\\redirect.txt")