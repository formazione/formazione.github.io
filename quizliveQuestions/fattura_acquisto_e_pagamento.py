...
traccia = "Ricevuta fattura di acquisto per 500 € + 10% di IVA"
# ogni volta che crei un conto si aggiunge la stringa col codice a testo
conto("Merci c/acquisti", "500", "0")
conto("Iva a credito", "50", "0")
conto("Debiti v/fornitori", "0", "550")
...
traccia2 = "Pagato in contanti fattura precedente"
testo = testo + tag("h3", "Esercizio 2") + tag("p", traccia2)

conto("Debiti v/fornitori", "550", "0")
conto("Denaro in cassa", "0", "550")
