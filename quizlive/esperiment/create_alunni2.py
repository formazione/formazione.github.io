...
def create_files(nomeclasse):
  ...
  <body>
  <!-- 
  domanda.insegnante4ae c'è la mia domanda
  ...
  <h1>5AE 2021 202 Console Insegnante4ae</h1>
  ...
  dbdomanda.on("value", snap => domanda_insegnante4ae.innerHTML = snap.val());
  ...
  for alunno in classe:
    ...
    file1 = file1.replace("4ae", nomeclasse)
  ...
  html = ""
  for n in classe:
         html += f"<h2><a href='https://formazione.github.io/quizclassi/experiment/{n}.html'>{n}</a></h2>"
